...
IO\textunderscore handling.hpp, IO\textunderscore handling.cpp} e \textbf{
main.cpp}. In \textbf{Boids.hpp} sono definiti tutti gli \textit{user defined 
...
funzioni che gestiscono la simulazione e il calcolo delle statistiche, mentre in
 \textbf{IO\textunderscore handling.hpp} sono dichiarate tutte le funzioni che 
